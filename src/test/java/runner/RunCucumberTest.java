...
@ConfigurationParameter(key = PLUGIN_PROPERTY_NAME, value = "html:target/cucumber.html," +
        "pretty:target/cucumber.pretty.txt,json:target/cucumber.json,summary,junit:target/cucumber.xml," +
        "progress")
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "org.example,common")
...
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "(@simple or @data) and not @rule")
